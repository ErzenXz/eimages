...
const apiKey = "yFuWlRku24r3MbjWwW448wtihYsoSG1DGbw3Ksft6KqPfSWuW0uDFwza";
const perPage = 27;
let currentPage = 1;
let searchTerm = null;
        ...
        `<li class="card">
            ...
            <div class="details">
                <div class="photographer">
                    ...
                    <span title="${img.photographer}">${img.photographer}</span>
                </div>
                <button title="Download" onclick="downloadImg('${img.src.large2x}');">
...
getImages(`https://api.pexels.com/v1/search?query=nature&page=1&per_page=${perPage}`);
